...
![external links]({{ site.baseurl }}/assets/images/primer/pic0.png)

Click on the "View Data" link, which brings up a page that looks like this:

![data links]({{ site.baseurl }}/assets/images/primer/pic1.png)
...
![pepXML page]({{ site.baseurl }}/assets/images/primer/pic2.png){: width="850"}
...
![models page]({{ site.baseurl }}/assets/images/primer/pic3.png){: width="850"}
...
![good score distributions]({{ site.baseurl }}/assets/images/primer/score1.png)     ![good score distributions]({{ site.baseurl }}/assets/images/primer/score2.png)
...
![good score distributions]({{ site.baseurl }}/assets/images/primer/score3.png)     ![good score distributions]({{ site.baseurl }}/assets/images/primer/score4.png)
...
![bad score distributions]({{ site.baseurl }}/assets/images/primer/score5.png)     ![bad score distributions]({{ site.baseurl }}/assets/images/primer/score7.png)
...
[![pepXML filtering]({{ site.baseurl }}/assets/images/primer/pepxml_filter.png){: width="600"}]({{ site.baseurl }}/assets/images/primer/pepxml_filter.png)
prot.xml FDR filtering:
[![protXML filtering]({{ site.baseurl }}/assets/images/primer/protxml_filter.png){: width="600"}]({{ site.baseurl }}/assets/images/primer/protxml_filter.png)
...
![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum1.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum2.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum3.png){: width="600"}

These are examples of very poor MS/MS spectra.

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum4.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum5.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum6.png){: width="600"}
...
![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum7.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum8.png){: width="600"}

![ms/ms spectrum]({{ site.baseurl }}/assets/images/primer/spectrum9.png){: width="600"}
...
![protXML view]({{ site.baseurl }}/assets/images/primer/prot1.png){: width="850"}
...
![protXML view]({{ site.baseurl }}/assets/images/primer/prot2.png){: width="850"}

Clicking on the far left column for a particular protein entry brings up these peptide details:

![protXML view]({{ site.baseurl }}/assets/images/primer/prot3.png){: width="850"}
...
![protein group]({{ site.baseurl }}/assets/images/primer/prot4.png){: width="850"}
...
![pepXML export]({{ site.baseurl }}/assets/images/primer/excel1.png){: width="850"}
...
![contaminant filter]({{ site.baseurl }}/assets/images/primer/filtercontam.png)

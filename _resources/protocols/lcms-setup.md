---
title: "LC-MS Setup"
permalink: /resources/protocols/lcms-setup/
redirect_from:
  - /methods/protocols05/
layout: single
toc: true
...
- [LC-MS commonly used consumables for VanquishNeo (xlsx)]({{ site.baseurl }}/docs/instruments/LC_MS_Consumables_VanquishNeo.xlsx)
- [Packing capillary columns (pdf)]({{ site.baseurl }}/docs/protocols05/Packing_Capillary_Columns.pdf)
- [UWPR pressure cell]({{ site.baseurl }}/resources/cores/pressurecell/)
- [Video: How to pull a capillary tip for LC/MS](http://www.benchfly.com/video/102/how-to-pull-a-capillary-tip-for-lc-ms/)
- [Video: How to pack a capillary column](http://www.benchfly.com/video/96/how-to-pack-a-capillary-column/)
- [Video: How to Bomb-load Capillary Tips or Frits for LC/MS](http://www.benchfly.com/video/104/how-to-bomb-load-capillary-tips-or-frits-for-/)
- [Video: Making Frits for LC/MS](http://www.benchfly.com/video/109/making-frits-for-lc-ms/)
...
- DIA overview [page]({{ site.baseurl }}/resources/knowledgebase/DIA/)

- PRM overview [page]({{ site.baseurl }}/resources/knowledgebase/PRM/)
...
- MRM/SRM overview [page]({{ site.baseurl }}/resources/knowledgebase/MRM/)
...
- [UWPR nanospray ionization source]({{ site.baseurl }}/resources/cores/nsisource/)
...
- [Interfacing a Waters nanoAcquity with a Thermo mass spec (pdf)]({{ site.baseurl }}/docs/protocols05/ThermoMassSpec_WatersNanoAcquity.pdf)
- [Fix for QEplus - nanoAcquity Contact Closure issues (pdf)]({{ site.baseurl }}/docs/protocols05/QEplus_nanoAcquity_ContactClosure.pdf)
- [Installing the nanoAcquity software with newer Xcalibur versions (pdf)]({{ site.baseurl }}/docs/protocols05/UWPR_nanoAcquity_SWinstallation.pdf)
- [Installing Xcalibur on Win 10 (pdf)]({{ site.baseurl }}/docs/protocols05/InstallingXcaliburOnWin10.pdf)
- [Rebooting nanoAcquity after an error (with newer Xcalibur versions) (pdf)]({{ site.baseurl }}/docs/protocols05/UWPR_nanoAcquity_Reboot.pdf)
- [nano HPLC sparging kit parts list (xls)]({{ site.baseurl }}/docs/protocols05/SpargingKit.xls)
- [Guide how to setup alternate EASY-nLC solvent filters (pdf)]({{ site.baseurl }}/docs/instruments/EASYnLC_SolventBottleFilters.pdf)
- [LC plumbing examples (pdf)]({{ site.baseurl }}/docs/protocols05/LC_plumbing.pdf)

- [UWPR N2 switch for low flow applications (pdf)]({{ site.baseurl }}/docs/protocols05/UWPR_N2_source_switch.pdf)
- [UWPR pressure cell]({{ site.baseurl }}/resources/cores/pressurecell/)
- [Spark Holland injection needle (pdf)]({{ site.baseurl }}/docs/protocols05/injection_needle.pdf)
- [list of common materials needed for Thermo mass spec installations (xls)]({{ site.baseurl }}/docs/protocols05/Materials_For_Thermo_MassSpec_Installations.xls)
- [MS direct infusion line (pdf)]({{ site.baseurl }}/docs/protocols05/MS_Direct_Infusion_Line.pdf)

## Miscellaneous

- Common Mass Spec Background Ions [go to page]({{ site.baseurl }}/resources/data-analysis/esi_background_ions/)
...
- [UWPR pressure cell]({{ site.baseurl }}/resources/cores/pressurecell/)
- [UWPR nanospray ionization source]({{ site.baseurl }}/resources/cores/nsisource/)
- [MRM/SRM page]({{ site.baseurl }}/resources/knowledgebase/MRM/)
- [PRM page]({{ site.baseurl }}/resources/knowledgebase/PRM/)
- [DIA page]({{ site.baseurl }}/resources/knowledgebase/DIA/)
- [Isotopic Labeling page]({{ site.baseurl }}/resources/knowledgebase/isotopic_labeling/)
- [Common Mass Spec Background Ions]({{ site.baseurl }}/resources/data-analysis/esi_background_ions/)
- [Repeating Units]({{ site.baseurl }}/resources/data-analysis/esi_background_ions_repeat_units/)

<?php  include("../__header.php"); ?>
            ...
            <!-- Page -->
               <div id="page" class="container">
                     ...
                     <div id="content" class="8u skel-cell-important">
                        <section>
                           <header class="major">
                              ...
                              <span class="byline">Protein digestion and Peptide labelling strategies</span>
                           </header>
				...
				<br>
				<ul>
				<li><strong>PPS Silent Surfactant</strong> (acid-cleavable detergent) is no longer available from Agilent or Abcam (former Expedion), but Creative Proteomics MSPro is selling a variety of acid cleavable surfactants:
			         <br><a target="new" href="https://mspro.creative-proteomics.com/ms-protein-sample-preparation-list-108.htm">MS Protein Sample Preparation products</a> 
				     
					 <br>Protocol <a target="new" href="/protocols03/PPS_SilentSurfactant.php">PPS Silent Surfactant page</a>
					 <br><a href="/docs/protocols03/expedeon_PPS_SilentSurfactant.pdf">Expedeon protocol</a> (former ProteinDiscovery) or 
				     <a href="/docs/protocols03/Agilent_PPS_SilentSurfactant.pdf">Agilent protocol</a>
					 <br><br>
			    <li><strong>RapiGest Surfactant</strong> <a href="https://www.waters.com/nextgen/us/en/products/standards-and-reagents/rapigest-sf-surfactant.html"> from Waters</a>
				...
				<p><h2 id="digestion">Enzymatic Digestion Protocols</h2>
				<br>
				</p>
				...
				<p>
				<a target="new" href="/cgi-bin/digest.cgi">UWPR Protein digestion calculator</a>
				</p>
                
				<p><h3>Digestion protocols</h3></p>
				<p>
				<ul>
				<li><a target="new" href="https://www.thermofisher.com/order/catalog/product/A45733">EasyPep&trade; MS Sample Prep Kits</a>
				<br>
				<br>
				<ul>
				<li><a target="new" href="/docs/protocols03/ThermoPierce_Trypsin_digestion.pdf">ThermoPierce Trypsin digestion protocol (pdf)</a>
				<br>
				<br>
				<li><a target="new" href="/docs/protocols03/Promega_TrypsinGoldMassSpectrometryGradeProtocol.pdf">Promega TrypsinGold MS GradeProtocol (pdf)</a>
				<br>
				<br>
				<li><a target="new" href="/docs/protocols03/Promega_SequencingGradeModifiedTrypsin.pdf">Promega_SequencingGradeModifiedTrypsin (pdf)</a>
				<br>Promega's sequencing grade Trypsin (V5111) is commonly used in proteomics, works well and is affordable...
				<br>
				<br>
				<li><a target="new" href="http://preomics.com/">PreOmics Kits</a> for sample preparation and peptide cleanup in the field of MS-based proteomics</a>
				...
				<br>
				<br>
				<li><a target="new" href="/docs/protocols03/UWPR_Protocols_Protein_Digestion_Protocols.pdf">Protein Digestion (pdf)</a>
				...
				<br>
				<br>
				<li><a target="new" href="https://protifi.com/pages/s-trap">S-Trap, Rapid universal MS sample prep</a> 
				...
				<br>Promega Thermolysin page is missing. <a target="new" href="https://www.fishersci.com/shop/products/thermolysin-from-geobacillus-s-5/501765019">Fischer Scientific's Thermolysin</a>.
		...
		<p><h2 id="chemicalcleavage">Chemical cleavage</h2>
				<br>
				<ul>
		...
		<p><h2 id="isotopiclabeling">Isotopic labeling</h2>
				<br>
				...
				<br><br>
				<li>ThermoPierce TMT (Tandem Mass Tag) Systems <a target="new" href="https://www.thermofisher.com/us/en/home/life-science/protein-biology/protein-mass-spectrometry-analysis/protein-quantitation-mass-spectrometry/tandem-mass-tag-systems.html">page</a>
				<br>Amine-reactive, TMTsixplex&trade; Isobaric Mass Tagging Kit <a target="new" href="https://www.thermofisher.com/order/catalog/product/90064B?SID=srch-srp-90064B#/90064B?SID=srch-srp-90064B">page</a>
				<br>Amine-reactive, TMT10plex&trade; Isobaric Mass Tagging Kit <a target="new" href="https://www.thermofisher.com/order/catalog/product/90113?SID=srch-srp-90113#/90113?SID=srch-srp-90113">page</a>
				<br>Amine-reactive, TMTpro&trade; 16-plex Label Reagent Set <a target="new" href="https://www.thermofisher.com/order/catalog/product/A44520#/A44520">page</a>
				<br>Cysteine-Reactive, iodoTMTsixplex&trade; Isobaric Label Reagent Se <a target="new" href="https://www.thermofisher.com/order/catalog/product/90101?SID=srch-srp-90101#/90101?SID=srch-srp-90101">page</a>
				<br>Carbonyl-reactive, aminoxyTMTsixplex&trade; Label Reagent Set <a target="new" href="https://www.thermofisher.com/order/catalog/product/90401?SID=srch-srp-90401#/90401?SID=srch-srp-90401">page</a>
				<br><br>
				...
				<p><h2 id="peptidecleanup">Peptide cleanup protocols for LC-MS</h2></p>
				<br>
				<p>
				<ul>
                     ...
                     <div id="sidebar" class="4u">
                        <section>
                           ...
                           <div class="row half">
                              <section class="6u">
                                 <ul class="default">
                                    <li><a href="#detergents">Detergents</a></li>
                                    <li><a href="#digestion">Enzymatic digestion</a></li>
                                    <li><a href="#chemicalcleavage">Chemical cleavage</a></li>
                                    <li><a href="#isotopiclabeling">Isotopic labeling</a></li>
                                    <li><a href="#peptidecleanup">Peptide cleanup</a></li>
                                 </ul>
                              </section>
                        ...
                        <section>
                           ...
                           <ul class="default">
                              <li><a target="new" href="/docs/protocols05/Avoid Contaminations.pdf">Avoid Contaminations (pdf)</a></li>
							  <li><a target="new" href="/protocols03/PPS_SilentSurfactant.php">PPS Silent Surfactant page</a></li>
                              <li><a target="new" href="/protocols03/RapiGestSurfactant.php">RapiGest Surfactant page</a></li>
                              <li><a target="new" href="/cgi-bin/digest.cgi">UWPR Protein digestion calculator</a></li>
                              <li><a target="new" href="/docs/protocols03/UWPR_Protocols_Protein_Digestion_Protocols.pdf">Protein Digestion (pdf)</a></li>
                              <li><a target="new" href="/protocols03/ingeldigestion.php">In-gel digest page</a></li>
							  <li><a target="new" href="/protocols03/FASPprotocols.php">FASP protocol</a></li>

...
[![pepXML filtering]({{ site.baseurl }}/assets/primer/pepxml_filter.png){width="600"}](pepxml_filter.png)  
prot.xml FDR filtering:  
[![protXML filtering]({{ site.baseurl }}/assets/primer/protxml_filter.png){width="600"}](protxml_filter.png)

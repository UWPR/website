...
permalink: /protocols06/primer/
---

*A primer on MS/MS analysis tools at UWPR.*
...
![pepXML page]({{ site.baseurl }}/protocols06/primer/pic2.png){width="850"}
...
![models page]({{ site.baseurl }}/protocols06/primer/pic3.png){width="850"}
...
![good score distributions]({{ site.baseurl }}/protocols06/primer/score1.png)     ![good score distributions]({{ site.baseurl }}/protocols06/primer/score2.png)
...
![good score distributions]({{ site.baseurl }}/protocols06/primer/score3.png)     ![good score distributions]({{ site.baseurl }}/protocols06/primer/score4.png)
...
![bad score distributions]({{ site.baseurl }}/protocols06/primer/score5.png)     ![bad score distributions]({{ site.baseurl }}/protocols06/primer/score7.png)
...
![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum1.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum2.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum3.png){width="600"}

These are examples of very poor MS/MS spectra.

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum4.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum5.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum6.png){width="600"}
...
![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum7.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum8.png){width="600"}

![ms/ms spectrum]({{ site.baseurl }}/protocols06/primer/spectrum9.png){width="600"}
...
![protXML view]({{ site.baseurl }}/protocols06/primer/prot1.png){width="850"}
...
![protXML view]({{ site.baseurl }}/protocols06/primer/prot2.png){width="850"}

Clicking on the far left column for a particular protein entry will bring up these peptide details:

![protXML view]({{ site.baseurl }}/protocols06/primer/prot3.png){width="850"}
...
![protein group]({{ site.baseurl }}/protocols06/primer/prot4.png){width="850"}
...
![pepXML export]({{ site.baseurl }}/protocols06/primer/excel1.png){width="850"}
...
![protXML export]({{ site.baseurl }}/protocols06/primer/excel2.png){width="850"}

For TMT or iTRAQ labeled samples, the tool that extracts the reporter ions signals is the Libra tool. Assuming the 6-plex TMT reagent was used, the resulting quantitative values would be reported as Libra1 through Libra6 corresponding to reporter ions from 126 through 131. The quantitative peptide and protein values are displayed as below and the actual values will be exported into the tab-delimited text files when exported as described above. [Here's the documentation, from back in 2006, that the Libra developers put together]({{ site.baseurl }}/protocols06/primer/libra_info.html) describing what it does.

![pepXML Libra]({{ site.baseurl }}/protocols06/primer/libra1.png){width="850"}

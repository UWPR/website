...
permalink: /protocols04/index.php
...
- Fractionation of peptides by strong cation-exchange liquid chromatography. Chan KC, Issaq HJ. *Methods Mol Biol.* 2013;1002:311-5. [link](http://www.ncbi.nlm.nih.gov/pubmed/23625412)
- Strong cation exchange chromatography in analysis of posttranslational modifications: innovations and perspectives. Edelmann MJ. *J Biomed Biotechnol.* 2011;2011:936508. [link](http://www.ncbi.nlm.nih.gov/pubmed/22174558)
- A solid phase extraction-based platform for rapid phosphoproteomic analysis. Dephoure N, Gygi SP. *Methods.* 2011 Aug;54(4):379-86 [link](http://www.ncbi.nlm.nih.gov/pubmed/21440633)
- Protocol for micro-purification, enrichment, pre-fractionation and storage of peptides for proteomics using StageTips. Rappsilber J, Mann M, Ishihama Y. *Nat Protoc.* 2007;2(8):1896-906 [link](http://www.ncbi.nlm.nih.gov/pubmed/17703201)

## Avidin

**Isolation of biotin labeled peptides**

- Check out this biotinylation overview at Pierce [link](http://www.piercenet.com/method/biotinylation)
- Pierce™ Cell Surface Biotinylation and Isolation Kit [link](https://www.thermofisher.com/order/catalog/product/A44390#/A44390)

**Spatial *in-vivo* biotinylation strategies**

- Spatially resolved proteomic mapping in living cells with the engineered peroxidase APEX2. Hung V, Udeshi ND, Lam SS, Loh KH, Cox KJ, Pedram K, Carr SA, Ting AY *Nat Protoc.* 2016 Mar;11(3):456-75. [link](https://www.ncbi.nlm.nih.gov/pubmed/26866790)
...
- [Thermo Pierce Fe-NTA Phosphopeptide Enrichment Kit](http://www.thermofisher.com/order/catalog/product/A32992) enables fast and efficient enrichment of phosphorylated peptides to process protein digests or strong cation-exchange peptide fractions for analysis by mass spectrometry
  \
- [Thermo Pierce TiO2 Phosphopeptide Enrichment and Clean-up Kit](http://www.thermofisher.com/order/catalog/product/A32993) enables fast, selective enrichment of phosphorylated peptides for mass spectrometry, it complements the Pierce Fe-NTA IMAC Phosphopeptide Enrichment Kit
  \
- [Sigma PHOS-Select Iron Affinity Gel](http://www.sigmaaldrich.com/catalog/product/sigma/p9740?lang=en&region=US) is an Iron \[Fe(III)\] chelate matrix based on Sigma's NTA analog chelate ligand. The matrix provides high capacity affinity binding of molecules containing phosphate groups
  \
- [Sigma PHOS-Select Gallium Silica Spin Column Kit](http://www.sigmaaldrich.com/catalog/product/supelco/55416u?lang=en&region=US) is a capture matrix is a Ga3+ chelate silica based on a proprietary nitriloacetic acid (NTA) analog
  \
...
These [spin columns (pdf)](/docs/protocols03/Nestgroup_minispinRPC.pdf) will retain non-polar solutes such as peptides (C18) , proteins (C4), and detergents. Salts, and polar solutes like DNA will not be retained\
...
[ThermoTechTip19 for detergent removal (pdf)](/docs/protocols03/Thermo_TechTip19_Detergent_Removal.pdf)\

[ThermoPierce Detergent Removal for low-concentration samples (pdf)](/docs/protocols03/ThermoPierce_DetergentRemoval.pdf)\

[ThermoPierce Detergent Removal for samples with proteins or peptides at greater than 100μg∕mL (pdf)](/docs/protocols03/ThermoPierce_DetergentRemoval_highConc.pdf)\

[Nestgroup Hydrophilic Interaction and Detergent Removal (pdf)](https://www.nestgrp.com/pdf/Ap2/minispinHILIC.pdf)\
HILIC [spin columns (pdf)](/docs/protocols03/Nestgroup_minispinHILIC.pdf) will retain polar solutes such as peptides, proteins, and polar metabolites. Salts, detergents, and non polar solutes will not be retained. This permits the removal of nonvolatile components from samples prior to mass spectrometry\
...
These [spin columns (pdf)](/docs/protocols03/Nestgroup_minispinSCX.pdf) will retain cationic solutes such as peptides, protein digests, or simple organic amines. Desalt samples prior to mass spectrometry.\
...
- [Peptide Fractionation and Cleanup (pdf)](/docs/protocols04/UWPR_Protocols_Peptide_Fractionation_and_Cleanup.pdf)\

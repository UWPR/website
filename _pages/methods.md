...
*Methods, Protocols, Hardware*

- [Proteomics: Protein Identification and Quantification]({{ site.baseurl }}/protocols01/)

- [Protein Preparation and Separation]({{ site.baseurl }}/protocols02/)  
  Protocols related to protein extraction from tissues, cells, body fluids and protein modification methods (SILAC, cross linking, etc) and protein separation: Cell fractionation, HPLC/FPLC, IP, etc
...
![]({{ site.baseurl }}/images/MSworkflow_01.png)
...
- [Protein Isolation and Purification Information](https://www.thermofisher.com/us/en/home/life-science/protein-biology/protein-biology-learning-center/protein-isolation-purification-information.html)
- [SharedProteomics protocols](http://sharedproteomics.com/)
- [UC Davis Proteomics Core Facility](https://proteomics.ucdavis.edu/protocols-2/)
- [Duke Proteomics and Metabolomics Shared Resource](https://genome.duke.edu/cores-and-services/proteomics-and-metabolomics/protocols-reagents)

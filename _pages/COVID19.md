...
**4/13/2020 UWPR lab specific COVID-19 guidlines [(pdf)]({{ site.baseurl }}/docs/safety/COVID19_UWPR_Specific_Guidelines.pdf)**
...
- Review the [COVID19_B59_Floorplan_2020]({{ site.baseurl }}/docs/safety/COVID19_B59_Floorplan_2020.pdf) before working in the lab
...
- [Acetic Acid (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_AceticAcid_FormicAcid_TrifluoroaceticAcid.docx)
- [Acetonitrile (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Acetonitrile.docx)
- [Butylamine (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Butylamine.docx)
- [Ethanol (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Methanol_IPA_Ethanol.docx)
- [Formamide]({{ site.baseurl }}/docs/safety/UWPR_SOP_Formamide.docx)
- [Formic Acid (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_AceticAcid_FormicAcid_TrifluoroaceticAcid.docx)
- [Gas Cylinder (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Gascylinder.docx)
- [HydrochloricAcid (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_HydrochloricAcid.docx)
- [Isopropanol (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Methanol_IPA_Ethanol.docx)
- [Mercaptoethanol (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Mercaptoethanol.docx)
- [Methanol (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Methanol_IPA_Ethanol.docx)
- [Reserpine (docx)]({{ site.baseurl }}/docs/safety/UWPR_SOP_Reserpine.docx)

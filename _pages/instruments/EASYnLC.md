...
permalink: /instruments/EASYnLC.php
...
[Detailed guide how to restart the virtual display (pdf)](/docs/instruments/EASYnLC_reconnect_virtual_display.pdf)\
...
- then hit "connect" to open the virtual display of the EASY-nLC touchscreen\
  \
  ![](/images/EASYnLC_03a.png)\
  \
  **Initial setup of Putty and the virtual display (e.g. on a new PC):**\
  [Guide how to initially setup the virtual display (pdf)](/docs/instruments/EASYnLC_setup_virtual_display.pdf)\
  \
...
Detailed guide how to switch between trapping and no-trapping mode [see pdf](/docs/instruments/EASYnLC_SwitchBetweenTrappingAndNoTrap.pdf)\
...
Detailed guide how to change the plate configuration [see pdf](/docs/instruments/EASYnLC_ChangingPlateConfiguration.pdf)\
...
- [Log Viewer usage(pdf)](/docs/instruments/EASYnLC_LogViewer.pdf)

You can download the zip file containing the log viewer.

- [EASY_nLC Log Viewer 2.18 (zip)](/docs/instruments/LogViewer218.zip)
...
- [LC-MS commonly used consumables for EASYnLC (xlsx)](/docs/instruments/LC_MS_Consumables_EASYnLC.xlsx)
...
- [LC-MS setup procedure EASYnLC(pdf)](/docs/instruments/UWPR_LC_MS_setup_EASYnLC.pdf)
- [Simple peptide standards for LC-MS (xlsx)](/docs/protocols05/AngioNeuroStandard.xlsx)
...
Detailed guide how to setup the EASY-nLC method [see pdf](/docs/instruments/EASYnLC_MethodSetup.pdf)\
...
Guide how to setup alternate EASY-nLC solvent filters [see pdf](/docs/instruments/EASYnLC_SolventBottleFilters.pdf)

## Upgrading Software/Firmware on the EASYnLC 1200 {#softwareupgrade}

[Back to Top](#top)\

This document describes how to upgrade software on an EASYnLC from SW 4.1 to SW 4.2: [see pdf](/docs/instruments/EASYnLC_SoftwareUpgrade.pdf)\
...
This document contains tips to manually troubleshoot air leaks in the checkvalve: [Easy nLC 1000 Check Valve Evaluation pdf](/docs/instruments/EasynLC_CheckValveEvaluation_07_15_2020_Rev%202.pdf)\

Easy nLC 1200 Key Changes over the 1000 Series: [Easy nLC 1200 Key Changes over the 1000 Series pdf](/docs/instruments/EasynLC1200_%20KeyChangesOverThe1000series_Rev%202.pdf)
...
- [Restart the virtual display (pdf)](/docs/instruments/EASYnLC_reconnect_virtual_display.pdf)
- [Initial setup of the virtual display (pdf)](/docs/instruments/EASYnLC_setup_virtual_display.pdf)
- [Switch between trapping and no-trapping mode (pdf)](/docs/instruments/EASYnLC_SwitchBetweenTrappingAndNoTrap.pdf)
- [Change the plate configuration (pdf)](/docs/instruments/EASYnLC_ChangingPlateConfiguration.pdf)
- [LC-MS column setup EASYnLC (pdf)](/docs/instruments/UWPR_LC_MS_setup_EASYnLC.pdf)
- [EASY-nLC method setup (pdf)](/docs/instruments/EASYnLC_MethodSetup.pdf)
- [Simple peptide standards for LC-MS (xlsx)](/docs/protocols05/AngioNeuroStandard.xlsx)
- [How to use the LogViewer (pdf)](/docs/instruments/EASYnLC_LogViewer.pdf)
- [Alternate EASY-nLC solvent filters (pdf)](/docs/instruments/EASYnLC_SolventBottleFilters.pdf)
- [EASYnLC_SoftwareUpgrade (pdf)](/docs/instruments/EASYnLC_SoftwareUpgrade.pdf)

...
permalink: /methods/protocols02/plasma/
classes: no_sidebar
...
- [The ENRICH-iST Kit](https://www.preomics.com/products/enrich-ist) from PreOmics enriches low-abundant proteins onto paramagnetic beads
...
2.  For each PC time group, add 30 μL of serum to a test tube.
...
8.  Place column in collection tube. Wash the multi-lectin resin solution with 200 μL of the 1x Binding/Wash Buffer by centrifugation for 1 min at 1,000 x g . Discard the fl ow-through. Repeat this step two times.
...
11. Remove top cap and then bottom cap from column. Place column in the collection tube and replace top ( see Note 7 ).
12. Centrifuge for 1 min at 1,000 x g . Collect the fl ow-through containing unbound/non-glycosylated proteins. Store on ice.
13. Reinsert column and add 400 μL 1x Binding/Wash Buffer to the resin. Cap column and centrifuge for 1 min at 1,000 x g . Collect the fl ow-through and combine with that of step 12. Repeat this step.
...
1.  [Plasma Proteome Database](http://www.plasmaproteomedatabase.org/)

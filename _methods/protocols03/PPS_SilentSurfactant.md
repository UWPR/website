...
permalink: /methods/protocols03/PPS_SilentSurfactant/
layout: single
toc: true
toc_sticky: true
classes: no_sidebar
...
PPS Silent surfactant is no longer available from Agilent or Abcam (former Expedion), but CreativeProteomics MSPro is selling a variety of acid cleavable surfactants:  
[MS Protein Sample Preparation products](https://mspro.creative-proteomics.com/ms-protein-sample-preparation-list-108.htm)

Use the PPS Silent Surfactant (acid-cleavable detergent) from [Expedeon]({{ site.baseurl }}/docs/protocols03/expedeon_PPS_SilentSurfactant.pdf) (former ProteinDiscovery) or [Agilent]({{ site.baseurl }}/docs/protocols03/Agilent_PPS_SilentSurfactant.pdf) to extract and solubilize hydrophobic proteins and improve in-solution enzymatic digestions of proteins.
...
3.  500 mM Dithiothreitol DTT (Fisher, part \# PI-20291) in H~2~O
4.  500 mM Iodoacetamide IAA (Fisher, part \# AC12227-0050) in H~2~O (0.0185g/ml; always prepare fresh, light sensitive)
5.  100 mM CaCl~2~
6.  500mM HCl
...
5.  Incubate sample at 50^o^C for 30 minutes.
...
9.  Add CaCl~2~ to a final concentration of 1mM.
...
11. Incubate 4h with shaking at 37^o^C.
...
1.  [Expedeon]({{ site.baseurl }}/docs/protocols03/expedeon_PPS_SilentSurfactant.pdf) (former ProteinDiscovery)
2.  [Agilent]({{ site.baseurl }}/docs/protocols03/Agilent_PPS_SilentSurfactant.pdf)

...
Origin: _methods/protocols01/indexProteinIsoSep.md (was /resources/sample-preparation/)
Reason: near-identical duplicate of protocols02/index.md, which moved to
        /resources/sample-preparation/ (that URL now redirects there too).
Action: diff against the surviving page, merge anything unique, then delete.
-->
...
- [In-gel digest page]({{ site.baseurl }}/resources/protocols/ingeldigestion/) for information about in-gel-digestion

...
Origin: _methods/protocols02/index_proteinSeparation.md (was /resources/sample-preparation/)
Reason: subset duplicate of the sample-preparation page's separation half.
Action: diff against /resources/sample-preparation/, merge anything unique, then delete.
-->

...
Origin: _methods/protocols04/peptideseparation.md (was /resources/sample-preparation/peptide-separation/)
Reason: orphan fragment duplicating plasma.md's TMT-labeling passage; unclear purpose.
Action: review, merge anything unique into sample-preparation pages, then delete.
-->
...
5.  Trypsin solution: 500 ng/μL sequencing-grade modified trypsin (Promega) in 5 mM acetic acid. Store at -20 ^o^C.
6.  SpeedVac.
...
2.  Add 5 μL of reducing solution (9.5 mM final concentration of tris(2-carboxyethyl) phosphine) and incubate for 1 h at 55 ^o^C.
...
4.  Add 5 μL of trypsin solution (2.5 μg/100 μg protein) and incubate overnight at 37 ^o^C.
...
1.  low retention eppendorf tubes.
2.  Acetonitrile (ACN): 100 % HPLC grade.
3.  Trifl uoroacetic acid (TFA): 100 % HPLC grade.
4.  Buffer A: 50 % ACN, 0.1 % TFA made with HPLC grade water.
5.  Buffer B: 25 % ACN, 0.1 % TFA made with HPLC grade water.
6.  Buffer C: Individual solutions of 100, 200, and 400 mM ammonium acetate, each in 25 % ACN, made with HPLC grade water.
7.  Disposable plastic columns (Thermo Scientific).
8.  SP Sepharose Fast Flow slurry (Sigma-Aldrich).

Method

1.  Prepare cartridges using disposable plastic columns filled with 650 μL of SP Sepharose Fast Flow slurry and a frit placed on top of the resin bed.
2.  Prior to peptide loading, wash cartridges with Buffer B (3 x 1 mL).
3.  Load samples in 3 mL Buffer A. Collect unbound material for later analysis ( see Note 10 ).
4.  Wash bound peptides with 4 mL of Buffer B (4 x 1 mL).
5.  Elute peptides from the cartridge with 2 mL of Buffer C; ammonium acetate at 100, 200, and 400 mM.
6.  Lyophilize the samples to dryness in a vacuum centrifuge.
